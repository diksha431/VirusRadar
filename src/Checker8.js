...
class Checker8 extends Component
{
    constructor()
    {
        super();
    ...
    Redirect=(e)=>
    {
        this.state.service = e.currentTarget.value;
        console.log(this.state.service)
            const service=this.state.service
            /* const data={service}
            Axios.get('http://localhost:9090/examples/public.jsp',{params:data}).then(response=>{console.log(response);
                ...
                <div style={{backgroundColor: "eeeff1",height:"10vh",width:"100%"}}>  </div>    
                    <Container maxWidth="xs" >
                        ...
                        <Card style={{marginTop:"1em"}}>
                            ...
                            <Typography variant="h6"  gutterBottom style={{fontSize:"1.2em",marginTop:"1em"}}>Is someone in your familystaying with you currently working for essential services in public exposedplaces (such as hospitals, retail outlets, delivery services)?</Typography>
