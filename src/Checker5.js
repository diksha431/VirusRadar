...
class Checker5 extends Component
{
    constructor()
    {
        super();
    ...
    Redirect=(e)=>
    {
        this.state.lab = e.currentTarget.value;
        console.log(this.state.lab)
            const lab=this.state.lab
            /* const data={lab}
            Axios.get('http://localhost:9090/examples/lab.jsp',{params:data}).then(response=>{console.log(response);
                ...
                <div style={{backgroundColor: "eeeff1",height:"10vh",width:"100%"}}>  </div>    
                    <Container maxWidth="xs" >
                        ...
                        <Card style={{marginTop:"1em"}}>
                            ...
                            <Typography variant="h6"  gutterBottom style={{fontSize:"1.2em",marginTop:"1em"}}>Have you or someone in your family staying with you came in close contact with a laboratory confirmed COVID-19 patientce in the last 14 days?</Typography>
